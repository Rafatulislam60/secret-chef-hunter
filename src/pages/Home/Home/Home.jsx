    ...
    <div className="bg-indigo-200 mb-16 flex lg:flex-cols lg:justify-around lg:px-14 mx-auto px-4 py-5">
      <div>
        ...
        <p className="my-6 text-xs sm:text-base md:text-lg max-w-2/3 md:max-w-xl max-w-2xl text-gray-900">
          Explore thousands of master chef with all the information you
          need. You can find here your future chef. Come find it. Manage  chef for your cuisine in a easy and fun process.
        </p>
        <Link to="/">
          <button
            type="button"
